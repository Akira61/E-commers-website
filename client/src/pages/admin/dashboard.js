    ...
    >
      ...
      <div className="sidebar-card d-none d-lg-flex">
        <img
          ...
          src="/dashboardImg/undraw_rocket.svg"
          alt="..."
        />
              ...
              >
                ...
                <a className="dropdown-item d-flex align-items-center" href="#">
                  <div className="dropdown-list-image mr-3">
                    <img
                      ...
                      src="/dashboardImg/undraw_profile_1.svg"
                      alt="..."
                    />
                ...
                <a className="dropdown-item d-flex align-items-center" href="#">
                  <div className="dropdown-list-image mr-3">
                    <img
                      className="rounded-circle"
                      src="/dashboardImg/undraw_profile_2.svg"
                      alt="..."
                    />
                ...
                <a className="dropdown-item d-flex align-items-center" href="#">
                  <div className="dropdown-list-image mr-3">
                    <img
                      className="rounded-circle"
                      src="/dashboardImg/undraw_profile_3.svg"
                      alt="..."
                    />
            ...
            <li className="nav-item dropdown no-arrow">
              ...
              >
                ...
                <img
                  ...
                  src="/dashboardImg/undraw_profile.svg"
                />
              </a>
                ...
                <div className="card-body">
                  <div className="text-center">
                    <img
                      ...
                      style={{ width: "25rem" }}
                      src="/dashboardImg/undraw_posting_photo.svg"
                      alt="..."
                    />
                  </div>
                  <p>
